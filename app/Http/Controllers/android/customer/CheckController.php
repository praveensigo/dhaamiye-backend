    ...
    **************/
    ...
    {        
        ...
        if ($validator->fails()) {
            ...
            $user = User::withTrashed()->where('mobile', $request->mobile)->where('country_code_id', $request->country_code)->where('role_id', 3)->first();
            if ($user) {
                if($user->deleted_at) {
        ...
        if ($validator->fails()) {
            ...
            if ($user) {
                ...
                if($request->email) {
                    ...
                    $user = User::withTrashed()->where('email', $request->email)->where('role_id', 3)->first();
